 ...
 */
package com.example.julyfifa.v3inventoryappstage1.data;
...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.julyfifa.v3inventoryappstage1/products" will map to the
        ...
        // For example, "content://com.example.julyfifa.v3inventoryappstage1/products/3" matches, but
        // "content://com.example.julyfifa.v3inventoryappstage1/products" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // For an example URI such as "content://com.example.julyfifa.v3inventoryappstage1/products/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // Check that the quantity is valid
        Integer supplier = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
        if (supplier == null) {
            throw new IllegalArgumentException("Product requires valid supplier name");
        }

        // Check that the quantity is valid
        Integer supplierPhone = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
